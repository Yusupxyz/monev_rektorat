...
(55, '042.01.01', '-', '-', 1081538000, 25, 20, 4000000, 16, 1),
(56, '5742', '-', '-', 1081538000, 25, 20, 4000000, 16, 1),
(57, '5742.001', '-', '-', 655041000, 25, 20, 4000000, 16, 1),
(59, '5742.001.002', '-', '-', 655041000, 25, 20, 4000000, 16, 1),
...
(6, '2642.001.001', '-', '-', 0, 36, 27, 4000000, 0, 1);
...
(5, 59, '051', 'Penerimaan Mahasiswa Baru', '-', '-', 21000000, 25, 20, 4000000),
...
(1, '::1', 'rektorat@admin.com', 1565331452),
(2, '::1', 'rektorat@rektorat.com', 1565331477);
...
(5, 'Waktu Pengisian Rencana Capaian', '2019-08-01', '2019-08-10'),
(7, 'Waktu Pengisian Realisasi Capaian Fisik', '2019-08-01', '2019-08-10');
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'XfERkEq7bkuTwbgQGlGLFe', 1268889823, 1565338259, 1, 'Admin', 'istratorr', 'ADMIN', '0', 0, '', ''),
...
(5, '::1', 'rekotrat@rekotrat.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'rekotrat@rekotrat.com', NULL, NULL, NULL, 'oFOO1kuHokNrnFHMZTHP4u', 1562004896, 1565338357, 1, 'admin', 'rektorat', 'Rektorat', '12424', 0, '', ''),
(6, '::1', 'ekonomi@ekonomi.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'ekonomi@ekonomi.com', NULL, NULL, NULL, 'dggqPO3Ak20f7bqgSeUeYe', 1562813018, 1565337451, 1, 'Operator', 'Ekonomi', 'Prodi Ekonomi', '12424', 16, '', ''),
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `komponen`
  MODIFY `id_komponen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `sub_komponen`
  MODIFY `id_subkomponen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
