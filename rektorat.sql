...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 27, 2019 at 10:14 AM
...
(85, '042.01.01', '-', '-', 2311900000, 0, 0, 0, 0, 1),
(86, '2642', '-', '-', 2311900000, 0, 0, 0, 0, 1),
(87, '2642.001', '-', '-', 2311900000, 0, 0, 0, 0, 1),
(88, '2642.001.001', '-', '-', 1211900000, 0, 0, 0, 0, 1),
(89, '5742', '-', '-', 0, 0, 0, 0, 0, 1),
(90, '5742.001', '-', '-', 0, 0, 0, 0, 0, 1),
(92, '5742.001.002', '-', '-', 1100000000, 0, 0, 0, 0, 1),
(93, '042.01.01', '-', '-', 361121000, 1, 0, 5000000, 16, 1),
(94, '5742', '-', '-', 361121000, 1, 0, 5000000, 16, 1),
(95, '5742.001', '-', '-', 361121000, 1, 0, 5000000, 16, 1),
(96, '5742.001.002', 'Layanan Pendidikan Program Sarjana', '-', 361121000, 1, 0, 5000000, 16, 1);
...
(31, 96, '052', 'Proses Belajar Mengajar', '-', '-', 326925000, 0, 0, 0),
...
(55, 27, 'A', 'Perlengkapan Mahasiswa Baru', '-', '-', 1100000000, 0, 0, 0),
(56, 30, 'DA', 'Pengenalan Kehidupan Kampus Bagi Mahasiswa Baru (PKKMB)', '-', '-', 20000000, 5, 1, 5000000),
(57, 31, 'DA', 'Ujian Tengah dan Ujian Akhir Semester Fakultas Ekonomi dan Bisnis', '-', '-', 326925000, 0, 0, 0),
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'XfERkEq7bkuTwbgQGlGLFe', 1268889823, 1566872976, 1, 'Admin', 'istratorr', 'ADMIN', '0', 0, '', ''),
...
(5, '::1', 'rektorat@rektorat.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'rektorat@rektorat.com', NULL, NULL, NULL, 'oFOO1kuHokNrnFHMZTHP4u', 1562004896, 1566803745, 1, 'admin', 'rektorat', 'Rektorat', '12424', 0, '', ''),
(6, '::1', 'ekonomi@ekonomi.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'ekonomi@ekonomi.com', NULL, NULL, NULL, 'dggqPO3Ak20f7bqgSeUeYe', 1562813018, 1566887121, 1, 'Operator', 'Ekonomi', 'Prodi Ekonomi', '12424', 16, '', ''),
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT for table `komponen`
--
ALTER TABLE `komponen`
  MODIFY `id_komponen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `realisasi`
  MODIFY `id_realisasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `sub_komponen`
  MODIFY `id_subkomponen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
