...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 29, 2019 at 04:08 AM
...
(186, '2642', '-', '-', 1, 0, 0, 0, 0, 1),
(187, '2642.001', '-', '-', 1, 0, 0, 0, 0, 1),
(188, '2642.001.001', '-', '-', 1, 0, 0, 0, 0, 1),
(189, '5742', '-', '-', 0, 0, 0, 0, 0, 1),
(190, '5742.001', '-', '-', 0, 0, 0, 0, 0, 1),
(191, '5742.001.002', '-', '-', 0, 0, 0, 0, 0, 1);
...
(195, 188, '004', 'A', '-', '-', 1, 0, 0, 0),
(196, 191, '051', 'a', '-', '-', 0, 0, 0, 0),
(198, 191, '052', 'a', '-', '-', 0, 0, 0, 0);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'XfERkEq7bkuTwbgQGlGLFe', 1268889823, 1567040532, 1, 'Admin', 'istratorr', 'ADMIN', '0', 0, '', ''),
...
(5, '::1', 'rektorat@rektorat.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'rektorat@rektorat.com', NULL, NULL, NULL, 'oFOO1kuHokNrnFHMZTHP4u', 1562004896, 1567039332, 1, 'admin', 'rektorat', 'Rektorat', '12424', 0, '', ''),
(6, '::1', 'ekonomi@ekonomi.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'ekonomi@ekonomi.com', NULL, NULL, NULL, 'dggqPO3Ak20f7bqgSeUeYe', 1562813018, 1567039282, 1, 'Operator', 'Ekonomi', 'Prodi Ekonomi', '12424', 16, '', ''),
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=196;

--
-- AUTO_INCREMENT for table `komponen`
--
ALTER TABLE `komponen`
  MODIFY `id_komponen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;
...
--
ALTER TABLE `realisasi`
  MODIFY `id_realisasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4105;
...
--
ALTER TABLE `sub_komponen`
  MODIFY `id_subkomponen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=375;
