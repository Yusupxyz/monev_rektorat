...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 25, 2019 at 02:18 AM
...
(55, '042.01.01', '-', '-', 2295638000, 11, 6, 4000000, 16, 1),
(56, '5742', '-', '-', 2295638000, 11, 6, 4000000, 16, 1),
(57, '5742.001', '-', '-', 1869141000, 5, 1, 4000000, 16, 1),
(59, '5742.001.002', '-', '-', 1869141000, 5, 1, 4000000, 16, 1),
(60, '5742.002', '-', '-', 84000000, 5, 5, 0, 16, 1),
(65, '042.01.01', '-', '-', 0, 0, 0, 0, 19, 1),
(66, '2642', '-', '-', 0, 0, 0, 0, 19, 1),
(67, '2642.001', '-', '-', 0, 0, 0, 0, 19, 1),
(68, '2642.002.001', '-', '-', 0, 0, 0, 0, 19, 1),
(74, '5742.994', '-', '-', 342497000, 1, 0, 0, 16, 1),
(75, '042.01.01', '-', '-', 5000000, 0, 0, 0, 17, 1),
(76, '2642', '-', '-', 5000000, 0, 0, 0, 17, 1),
(77, '2642.001', '-', '-', 5000000, 0, 0, 0, 17, 1),
(78, '2642.001.001', '-', '-', 3000000, 0, 0, 0, 17, 1),
(79, '2642.002.001', '-', '-', 2000000, 0, 0, 0, 17, 1),
(80, '042.01.01', '-', '-', 522550000, 0, 0, 0, 0, 1),
(81, '2642', '-', '-', 522550000, 0, 0, 0, 0, 1),
(82, '2642.001', '-', '-', 522550000, 0, 0, 0, 0, 1),
(83, '2642.001.001', '-', '-', 522550000, 0, 0, 0, 0, 1),
(84, '5741.994', '-', '-', 0, 0, 0, 0, 0, 1);
...
(5, 59, '051', 'Penerimaan Mahasiswa Baru', '-', '-', 532550000, 36, 10, 4000000),
(6, 59, '052', 'Proses Belajar Mengajar\r\n', '-', '-', 386925000, 5, 0, 0),
(9, 59, '053', 'Wisuda dan Yudisium\r\n', '-', '-', 575490000, 0, 0, 0),
(10, 60, '056', 'Penerbitan Jurnal\r\n', '-', '-', 84000000, 5, 5, 0),
(13, 59, '057', 'Administrasi Pendidikan', '-', '-', 48072000, 2, 0, 0),
(14, 59, '059', 'Kegiatan Kemahasiswaan', '-', '-', 19000000, 0, 0, 0),
(15, 59, '063', 'Pengembangan Kurikulum, Akreditasi, dan Mutu Akademik', '-', '-', 103014000, 0, 0, 0),
(16, 59, '064', 'Seminar/Pelatihan/Workshop Pengembangan Mutu SDM Tenaga Pendidik', '-', '-', 77090000, 0, 0, 0),
(17, 59, '065', 'Pembayaran Honorarium Tugas Tambahan dan Kelebihan Jam Mengajar', '-', '-', 127000000, 0, 0, 0),
(18, 74, '051', 'Penyelenggaraan Operasional Perkantoran', '-', '-', 326497000, 1, 0, 0),
(19, 74, '057', 'Penyusunan Dokumen/Laporan Sistem Tata Kelola dan Kelembagaan\r\n', '-', '-', 16000000, 0, 0, 0),
(20, 78, '051', 'asd', '-', '-', 3000000, 0, 0, 0),
(21, 79, '057', '123213', '2321', '-', 2000000, 0, 0, 0),
(22, 83, '051', 'as', '-', '-', 522550000, 14, 4, 4000000);
...
(1, 1, 12, 16, 10, 'Terlaksana Pendaftaran', 5, 2000000, 'sdh ada 50 mahasiswa mendaftar', '-', '-'),
(2, 2, 12, 16, 15, 'Kegiatan Mulai', 15, 2000000, 'Kegiatan sdh terlaksan 2 hari', '-', '-'),
(3, 3, 12, 16, 20, '-', 0, 0, '-', '-', '-'),
(4, 4, 12, 16, 25, '-', 0, 0, '-', '-', '-'),
(5, 5, 12, 16, 0, '-', 0, 0, '-', '-', '-'),
(6, 6, 12, 16, 0, '-', 0, 0, '-', '-', '-'),
...
(16, 13, 'DA', 'Penyusunan Buku Panduan Penulisan Proposal dan Skripsi Fakultas Ekonomi dan Bisnis', '-', '-', 3200000, 0, 0, 0),
(17, 13, 'DB', 'Pembuatan Buku Profil Fakultas Ekonomi dan Bisnis\r\n', '-', '-', 10996000, 5, 0, 0),
(18, 13, 'DC', 'Buku Panduan Akademik Fakultas Ekonomi dan Bisnis\r\n', '-', '-', 3140000, 5, 0, 0),
(19, 13, 'DD', 'Rapat Koordinasi Kegiatan Akademik FEB\r\n', '-', '-', 12000000, 0, 0, 0),
(20, 13, 'DE', 'Pengisian PDPT Mahasiswa dan Dosen', '-', '-', 4736000, 0, 0, 0),
(21, 13, 'DF', 'Penyelenggaraan Kegiatan Akademik FEB', '-', '-', 14000000, 0, 0, 0),
(22, 14, 'DB', 'Kegiatan Mahasiswa Dalam Rangka Dies Natalis FEB', '-', '-', 12000000, 0, 0, 0),
(23, 14, 'DC', 'Muswil Ikatan Senat Mahasiswa Ekonomi Indonesia Fakultas Ekonomi dan Bisnis\r\n', '-', '-', 5000000, 0, 0, 0),
(24, 14, 'DD', 'Pemilihan, Pelantikan Gubernur dan Wakil BEM FEB', '-', '-', 2000000, 0, 0, 0),
(25, 15, 'DA', 'Unit Penjaminan Mutu Fakultas Ekonomi dan Bisnis\r\n', '-', '-', 5000000, 0, 0, 0),
(26, 15, 'DB', 'Gugus Penjaminan Mutu 3 Jurusan Fakultas Ekonomi dan Bisnis', '-', '-', 15000000, 0, 0, 0),
(27, 15, 'DC', 'Penyusunan dan Pembahasan RPS/Kurikulum 3 Jurusan Fakultas Ekonomi dan Bisnis', '-', '-', 15000000, 0, 0, 0),
(28, 15, 'DD', 'Penyusunan Akreditasi Jurusan di FEB', '-', '-', 68014000, 0, 0, 0),
(29, 16, 'DA', 'Penyelenggaraan Seminar Nasional Fakultas Ekonomi dan Bisnis', '-', '-', 63822000, 0, 0, 0),
(30, 16, 'DC', 'Mengikuti IAPI 3.0 Jurusan Akuntansi FEB', '-', '-', 13268000, 0, 0, 0),
(31, 17, 'DA', 'Operasional Management Fakultas Ekonomi dan Bisnis', '-', '-', 7000000, 0, 0, 0),
(32, 18, 'DA', 'Keperluan Sehari-hari Perkantoran dan Kerumahtanggaan FEB', '-', '-', 185665000, 2, 0, 0),
(33, 18, 'DC', 'Senat Fakultas Ekonomi dan Bisnis', '-', '-', 10480000, 0, 0, 0),
(34, 18, 'zz', 'Perjalanan Koordinasi/Konsultasi Fakultas/Pascasarjana/Lembaga/UPT', '-', '-', 130352000, 0, 0, 0),
(35, 19, 'DO', 'Pengelolaan Keuangan di FEB', '-', '-', 10000000, 0, 0, 0),
(36, 19, 'DR', 'Penyusunan Renstra FEB', '-', '-', 6000000, 0, 0, 0),
(37, 20, 'DA', 'asdsad', '-', '-', 3000000, 0, 0, 0),
(40, 21, 'sdd', 'dd', '-', '-', 2000000, 0, 0, 0),
(41, 22, 'A', 'ass', '-', '-', 522550000, 0, 0, 0),
(42, 17, 'EA', 'xxxxxxxxxxxxxx', '-', '-', 60000000, 0, 0, 0),
(43, 17, 'EA', 'abc', '-', '-', 60000000, 0, 0, 0),
(44, 5, 'DA', 'xxcc', '-', '-', 522550000, 2, 0, 0),
(45, 6, 'DA', 'sds', '-', '-', 60000000, 0, 0, 0),
(46, 16, 'DA', 'sds', '-', '-', 0, 0, 0, 0),
(47, 15, 'DA', 'sd', 's', 'Mahasiswa', 0, 0, 0, 0),
(48, 9, 'DA', 's', '-', '-', 522550000, 0, 0, 0);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'XfERkEq7bkuTwbgQGlGLFe', 1268889823, 1566556394, 1, 'Admin', 'istratorr', 'ADMIN', '0', 0, '', ''),
...
(5, '::1', 'rektorat@rektorat.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'rektorat@rektorat.com', NULL, NULL, NULL, 'oFOO1kuHokNrnFHMZTHP4u', 1562004896, 1566660279, 1, 'admin', 'rektorat', 'Rektorat', '12424', 0, '', ''),
(6, '::1', 'ekonomi@ekonomi.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'ekonomi@ekonomi.com', NULL, NULL, NULL, 'dggqPO3Ak20f7bqgSeUeYe', 1562813018, 1566556894, 1, 'Operator', 'Ekonomi', 'Prodi Ekonomi', '12424', 16, '', ''),
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `komponen`
--
ALTER TABLE `komponen`
  MODIFY `id_komponen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `realisasi`
  MODIFY `id_realisasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
...
--
ALTER TABLE `sub_komponen`
  MODIFY `id_subkomponen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
