...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 18, 2019 at 08:37 PM
...
(55, '042.01.01', '-', '-', 1080538000, 50, 20, 4000000, 16, 1),
(56, '5742', '-', '-', 1080538000, 50, 20, 4000000, 16, 1),
(57, '5742.001', '-', '-', 654041000, 50, 20, 4000000, 16, 1),
(59, '5742.001.002', '-', '-', 654041000, 50, 20, 4000000, 16, 1),
...
(74, '5742.994', '-', '-', 342497000, 0, 0, 0, 16, 1),
...
(6, '2642.001.001', '-', '-', 0, 61, 27, 4000000, 0, 1);
...
(5, 59, '051', 'Penerimaan Mahasiswa Baru', '-', '-', 20000000, 45, 20, 4000000),
(6, 59, '052', 'Proses Belajar Mengajar\r\n', '-', '-', 326925000, 5, 0, 0),
(9, 59, '053', 'Wisuda dan Yudisium\r\n', '-', '-', 52940000, 0, 0, 0),
(10, 60, '056', 'Penerbitan Jurnal\r\n', '-', '-', 84000000, 0, 0, 0),
(13, 59, '057', 'Administrasi Pendidikan', '-', '-', 48072000, 0, 0, 0),
...
(17, 59, '065', 'Pembayaran Honorarium Tugas Tambahan dan Kelebihan Jam Mengajar', '-', '-', 7000000, 0, 0, 0),
(18, 74, '051', 'Penyelenggaraan Operasional Perkantoran', '-', '-', 326497000, 0, 0, 0),
...
(1, 6, '051', 'asas', '-', '-', 0, 52, 27, 4000000),
(2, 6, '052', 'as', 's', 's', 0, 9, 0, 0);
...
(1, '::1', 'ekonomit@ekonomi.com', 1566145496);
...
(32, 18, 'DA', 'Keperluan Sehari-hari Perkantoran dan Kerumahtanggaan FEB', '-', '-', 185665000, 0, 0, 0),
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', 'm0vyKu2zW7L8PTG20bquF.707e055aeea8a30aca', 1541329145, 'XfERkEq7bkuTwbgQGlGLFe', 1268889823, 1566150437, 1, 'Admin', 'istratorr', 'ADMIN', '0', 0, '', ''),
...
(5, '::1', 'rektorat@rektorat.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'rektorat@rektorat.com', NULL, NULL, NULL, 'oFOO1kuHokNrnFHMZTHP4u', 1562004896, 1566149945, 1, 'admin', 'rektorat', 'Rektorat', '12424', 0, '', ''),
(6, '::1', 'ekonomi@ekonomi.com', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'ekonomi@ekonomi.com', NULL, NULL, NULL, 'dggqPO3Ak20f7bqgSeUeYe', 1562813018, 1566145509, 1, 'Operator', 'Ekonomi', 'Prodi Ekonomi', '12424', 16, '', ''),
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `id_unit`, `foto`, `foto_nama`) VALUES
(9, '::1', 'a@rektorat.com', '$2y$08$nFtcCH5MsPydkpt4V0DdTu5g1rH7YeccTcJhY1OwH8.hr7RTzT21O', NULL, 'a@rektorat.com', NULL, NULL, NULL, NULL, 1566121035, 1566150201, 1, 'A', 'B', 'Rektorat', 'admin@admin.com', 0, '', '');
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `komponen`
  MODIFY `id_komponen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `realisasi`
  MODIFY `id_realisasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;

--
-- AUTO_INCREMENT for table `realisasi_rektorat`
--
ALTER TABLE `realisasi_rektorat`
  MODIFY `id_realisasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `sub_komponen`
  MODIFY `id_subkomponen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `sub_komponen_rektorat`
--
ALTER TABLE `sub_komponen_rektorat`
  MODIFY `id_subkomponen` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
