              ...
              ?>
                <div id="infoMessage" class="callout callout-danger"><?php echo $message;?></div> <?php } ?>
                  <?php echo form_open(uri_string());?>
                    ...
                    <div class="form-group">
                          <?php echo lang('edit_user_parent_unit', 'id_unit');?> <br />
                          <?php $attritbute = 'class="form-control"';?>
                          <?php echo form_dropdown('id_unit', $unit, $selected, $attritbute);?>
                    </div>
                    ...
                    <?php //echo form_hidden('id_unit', $user->id_unit);?>
