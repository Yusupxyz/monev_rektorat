    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Realisasi Rektorat Detail</h3>
            ...
            <div class="box-body">
        <table class="table">
	    <tr><td>Id Realisasi</td><td><?php echo $id_realisasi; ?></td></tr>
	    ...
	    <tr><td><a href="<?php echo site_url('realisasi_rektorat') ?>" class="btn bg-purple">Cancel</a></td></tr>
	</table>
            </div>
        </div>
    </div>
