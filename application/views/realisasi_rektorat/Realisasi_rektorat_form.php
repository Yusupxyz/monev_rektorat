    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?= $button;?> Realisasi_rektorat</h3>
	    ...
	    <div class="form-group">
            <label for="int">Id Realisasi <?php echo form_error('id_realisasi') ?></label>
            <input type="text" class="form-control" name="id_realisasi" id="id_realisasi" placeholder="Id Realisasi" value="<?php echo $id_realisasi; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('realisasi_rektorat') ?>" class="btn btn-default">Cancel</a>
	</form>
         </div>
        </div>
    </div>
