    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-12">
                <?php echo anchor(site_url('kegiatan/create'),'<i class="fa fa-plus"></i> Tambah Program Induk', 'class="btn bg-purple"'); ?>
                <?php echo anchor(site_url('kegiatan/create/program'),'<i class="fa fa-plus"></i> Tambah Program', 'class="btn bg-green"'); ?>
                <?php echo anchor(site_url('kegiatan/create/sub_program'),'<i class="fa fa-plus"></i> Tambah Sub Program', 'class="btn bg-maroon"'); ?>
                <?php echo anchor(site_url('kegiatan/create/sub_output'),'<i class="fa fa-plus"></i> Tambah Sub Output', 'class="btn bg-yellow"'); ?>
            </div>
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $kegiatan->id_kegiatan;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
                ...
                if ($kegiatan->jenis!='1' && $kegiatan->jenis!='2'){
                    ...
                    echo anchor(site_url('kegiatan/create/komponen/'.$kegiatan->id_kegiatan),'<i class="fa fa-plus"></i>', 'class="btn btn-xs btn-success"  data-toggle="tooltip" title="Tambah Komponen"'); 
                    echo ' '; 
                    }
                }
                    ...
                    if($count_child[$i]->jumlah_anak=='0'){
                        ...
                        <tr>
                            ...
                            <?php 
                                if ($kegiatan->jenis!='1' && $kegiatan->jenis!='2'){
                                    if($count_child[$i]->jumlah_anak=='0'){
                                    echo anchor(site_url('kegiatan/create/subkomponen/'.$value->id_komponen),'<i class="fa fa-plus"></i>', 'class="btn btn-xs btn-default"  data-toggle="tooltip" title="Tambah Sub Komponen"'); 
                                    echo ' '; 
                                    }
                                }
