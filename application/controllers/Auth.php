...
class Auth extends CI_Controller
{
	...
	public function create_user()
	{
		...
		$currentGroups = $this->ion_auth->get_users_groups()->result_array();
	    ...
	    $this->data["unit"] = $this->db->query("select * from unit")->result();
	...
	*/
	...
	public function edit_user($id)
	{
		...
		$this->data['unit'] = $this->unit_model->get_all();
		$this->data['selected'] =$this->form_validation->set_value('id_unit', $user->id_unit);
