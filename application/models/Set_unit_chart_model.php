...
class Set_unit_chart_model extends CI_Model
{

    public $table = 'set_unit_chart';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Set_unit_chart_model.php */
/* Location: ./application/models/Set_unit_chart_model.php */
